    ...
    public class AuthServerDataSeeder : IDataSeedContributor, ITransientDependency
    {
        ...
        private async Task CreateClientsAsync()
        {
            ...
            await CreateClientAsync(
                ...
                redirectUri: "http://192.168.0.123:10001/signin-oidc",
                postLogoutRedirectUri: "http://192.168.0.123:10001/signout-callback-oidc"
            );
            ...
            await CreateClientAsync(
                ...
                new[] { "hybrid" },
                commonSecret,
                redirectUri: "http://192.168.0.123:10002/signin-oidc",
                postLogoutRedirectUri: "http://192.168.0.123:10002/signout-callback-oidc"
            );
